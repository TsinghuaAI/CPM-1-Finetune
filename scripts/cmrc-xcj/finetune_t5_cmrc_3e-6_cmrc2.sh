...
CKPT_PATH="/mnt/sfs_turbo/CPM-Finetune-xcj/results/t5_finetune_cmrc2_lr0.000003const_dropout_fix2/300"

SAVE_PATH="${WORKING_DIR}/results/t5_finetune_cmrc2_lr${LR}const_dropout_fix2/"
