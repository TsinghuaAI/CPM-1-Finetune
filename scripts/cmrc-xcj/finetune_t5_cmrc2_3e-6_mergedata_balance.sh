...
DATA_EXT=".json"
CACHE_PATH="/cache/"
DATA_PATH="/mnt/sfs_turbo/data/CLUE/cmrc/cail/merge_balance"
...
# CKPT_PATH="/mnt/sfs_turbo/CPM-Finetune-xcj/results/t5_finetune_cmrc_lr0.000003const_dropout_fix2"

SAVE_PATH="${WORKING_DIR}/results/t5_finetune_cmrc2_lr${LR}const_dropout_fix2_merge_balance/"
