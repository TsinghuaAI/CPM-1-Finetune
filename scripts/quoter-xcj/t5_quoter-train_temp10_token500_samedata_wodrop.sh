...
DATA_EXT=".json"
CACHE_PATH="/cache/"
DATA_PATH="/mnt/sfs_turbo/data/qingyuan/quoter/samedata"
...
SAVE_PATH="${WORKING_DIR}/results/t5_quoter/t5_quoter_tar500_samedata_wodrop_lr${LR}_bs${BATCH_SIZE}-${GRAD_ACC}_temp${TEMP}const_drop/"
