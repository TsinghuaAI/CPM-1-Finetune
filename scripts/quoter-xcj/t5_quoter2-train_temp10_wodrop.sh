...
CKPT_PATH="/mnt/sfs_turbo/enc-dec-pretrain/checkpoints/checkpoint-4-19-8MP/"
...
SAVE_PATH="${WORKING_DIR}/results/t5_quoter/afterDel/t5_quoter2_wodrop_lr${LR}_bs${BATCH_SIZE}-${GRAD_ACC}_temp${TEMP}const/"
