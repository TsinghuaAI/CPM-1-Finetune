...
CKPT_PATH="/mnt/sfs_turbo/CPM-Finetune-xcj/results/t5_sogou-log/t5_sogou-log_lr0.000003_bs8-8const_drop"
...
SAVE_PATH="${WORKING_DIR}/results/t5_sogou-log/t5_sogou-log-infer_lr${LR}_bs${BATCH_SIZE}-${GRAD_ACC}const_drop/"
