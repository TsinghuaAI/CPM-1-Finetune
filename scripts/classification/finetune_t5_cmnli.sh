...
DATA_EXT=".json"
CACHE_PATH="/cache/"
DATA_PATH="/mnt/sfs_turbo/data/CLUE/cmnli"
...
CKPT_PATH="/mnt/sfs_turbo/CPM-Finetune/results/t5_finetune_cmnli_lr0.000005_drop"

SAVE_PATH="${WORKING_DIR}/results/t5_finetune_cmnli_lr0.000005_drop/"
