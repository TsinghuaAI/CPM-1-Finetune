...
CKPT_PATH="/mnt/sfs_turbo/enc-dec-pretrain/results/enc_dec_mt5_2021-5-1/"
...
SAVE_PATH="${WORKING_DIR}/results/t5_c3_2_rightID_lr${LR}_bs${BATCH_SIZE}-${GRAD_ACC}const_drop/"
