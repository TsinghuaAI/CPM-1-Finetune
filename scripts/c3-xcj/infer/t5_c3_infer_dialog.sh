...
DATA_EXT=".json"
CACHE_PATH="/cache/"
DATA_PATH="/mnt/sfs_turbo/data/CLUE/c3/dialog"

CONFIG_PATH="${WORKING_DIR}/configs/model/enc_dec_xlarge_8_config_drop.json"

CKPT_PATH="/mnt/sfs_turbo/CPM-Finetune-xcj/results/t5_c3_2_rightID_lr0.000003_bs4-4const_drop/800"
...
SAVE_PATH="${WORKING_DIR}/results/c3_infer/dialog"
