...
"""Generate responses for contexts in dialogs (supervised model)"""
    ...
    with torch.no_grad():
        for data_pair in test_data:
            ...
            if mpu.get_model_parallel_rank() == 0:
                ...
                output_tokens_list = tokens.view(-1).contiguous()
                decode_tokens = tokenizer.decode(output_tokens_list.tolist())
                trim_decode_tokens = decode_tokens[decode_tokens.rfind("回复:")+3:decode_tokens.find("<eod>")]
